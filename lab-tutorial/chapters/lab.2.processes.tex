        ...
        \begin{bytefield}{24}
            ...
            \begin{leftwordgroup}{2. Address determined\\ by the MOS Kernel}
                \begin{rightwordgroup}{4. Per-thread\\Memory Regions}
                    \memsection{}{}{2}{lightred}{\scriptsize{Kernel-Mode Thread Stacks \dots}}\\
                    \memsection{}{}{2}{cyan}{\scriptsize{User-Mode Thread Stacks \dots}}
                \end{rightwordgroup}\\
                \begin{rightwordgroup}{4. \textit{Main Thread}\\Memory Regions}
            ...
            \begin{leftwordgroup}{1. Address determined\\ by the Program Header}
                \memsection{}{}{3}{cyan}{BSS Section}\\
                \memsection{}{}{3}{cyan}{R/W Data Section}\\
                \memsection{}{}{2}{lightgreen}{RO Data Section}\\
                \memsection{}{0x08048000}{2}{lightgreen}{Text Section}
            \end{leftwordgroup}\\
