...
{
    test_structure pp = { 0, MOS_LIST_NODE_INIT(pp), 1 };
    ...
    list_node_t head = MOS_LIST_HEAD_INIT(head);
    ...
    test_structure p1 = { 0, MOS_LIST_NODE_INIT(p1), 1 };
...
{
    list_node_t list_head = MOS_LIST_HEAD_INIT(list_head);
    test_structure s1 = { 1, MOS_LIST_NODE_INIT(s1), 2 };
    test_structure s2 = { 3, MOS_LIST_NODE_INIT(s2), 4 };
    test_structure s3 = { 5, MOS_LIST_NODE_INIT(s3), 6 };
    test_structure s4 = { 7, MOS_LIST_NODE_INIT(s4), 8 };
    test_structure s5 = { 9, MOS_LIST_NODE_INIT(s5), 10 };
...
MOS_TEST_CASE(test_list_node_insert)
{
    ...
    test_structure new_s = { 11, MOS_LIST_NODE_INIT(new_s), 12 };
    test_structure new_s2 = { 13, MOS_LIST_NODE_INIT(new_s2), 14 };
