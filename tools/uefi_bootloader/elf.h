 ...
 * @param[out]   kernel_program_headers_buffer The buffer to read the kernel program headers into.
 ...
 * @retval EFI_UNSUPPORTED           If the identity buffer indicates an unsupported file type.
 * @retval EFI_INCOMPATIBLE_VERSION  If the identity buffer indicates an unsupported file type.
 */
