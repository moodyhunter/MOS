...
#define madt_type_is_valid(var) (var->record_length && ((var->type >= 0 && var->type <= 5) || var->type == 9))
#define madt_entry_foreach(var, madt)                                                                                                                                    \
    for (auto var = (acpi_madt_header_t *) ((char *) madt + sizeof(acpi_madt_t)); madt_type_is_valid(var);                                                               \
         var = (acpi_madt_header_t *) ((char *) var + var->record_length))
