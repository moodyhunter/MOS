    ...
    madt_entry_foreach(entry, x86_acpi_madt)
    {
        switch (entry->type)
        {
            ...
            case 3:
            {
                ...
                pr_dwarn(x86_acpi, "Unhandled MADT entry type 3 (IOAPIC NMI)");
                break;
            }
            case 4:
            {
                ...
                pr_dwarn(x86_acpi, "Unhandled MADT entry type 4 (LAPIC NMI)");
                break;
            }
            case 5:
            {
                ...
                pr_dwarn(x86_acpi, "Unhandled MADT entry type 5 (LAPIC address override)");
                break;
            }
            case 9:
            {
                ...
                pr_dwarn(x86_acpi, "Unhandled MADT entry type 9 (local x2 SAPIC override)");
                break;
            }
            default:
            {
