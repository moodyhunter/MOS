...
ptr_t mm_get_free_pages(mm_context_t *table, size_t n_pages, ptr_t base_vaddr, valloc_flags flags);
 ...
 */
vmblock_t mm_alloc_pages(mm_context_t *table, size_t n_pages, ptr_t hint_vaddr, valloc_flags valloc_flags, vm_flags flags);
 ...
 */
vmblock_t mm_map_pages(mm_context_t *table, ptr_t vaddr, pfn_t pfn, size_t npages, vm_flags flags);
 ...
 */
void mm_unmap_pages(mm_context_t *table, ptr_t vaddr, size_t npages);
 ...
 */
vmblock_t mm_replace_mapping(mm_context_t *table, ptr_t vaddr, pfn_t pfn, size_t npages, vm_flags flags);
 ...
 */
void mm_flag_pages(mm_context_t *table, ptr_t vaddr, size_t npages, vm_flags flags);
