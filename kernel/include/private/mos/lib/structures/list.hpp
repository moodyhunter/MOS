 ...
 */
#define list_foreach(t, v, h) for (auto v = list_entry((h).next, t), __next = list_next_entry(v, t); list_node(v) != &(h); v = __next, __next = list_next_entry(v, t))

#define list_foreach_reverse(t, v, h)                                                                                                                                    \
    for (auto v = list_entry((h).prev, t), __next = list_prev_entry(v, t); list_node(v) != &(h); v = __next, __next = list_prev_entry(v, t))
...
#define list_headless_foreach(t, v, h)                                                                                                                                   \
    for (t *v = &(h), *__next = list_next_entry(v, t), *__head = nullptr; (v) != __head;                                                                                 \
         v = __next, __next = list_next_entry(v, t), __head = __head == nullptr ? &(h) : __head)

#define list_headless_foreach_reverse(t, v, h)                                                                                                                           \
    for (t *v = &(h), *__next = list_prev_entry(v, t), *__head = nullptr; (v) != __head;                                                                                 \
         v = __next, __next = list_prev_entry(v, t), __head = __head == nullptr ? &(h) : __head)
