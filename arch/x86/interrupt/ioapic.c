...
void ioapic_init(void)
{
    ...
    mm_map_pages(x86_platform.kernel_pgd, x86_ioapic_address, x86_ioapic_address, 1, VM_RW);
...
{
    pr_info2("ioapic: enable irq %d, cpu %d, trigger_mode %d, polarity %d", irq, cpu, trigger_mode, polarity);
